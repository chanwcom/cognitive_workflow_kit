...
WAV_TOP_DIR = "/mnt/nas2dual/database/libri_light_finetuning/org_decompressed"
TRANS_TOP_DIR = "/mnt/nas2dual/database/libri_light_finetuning/tool"
OUT_TOP_DIR = "/mnt/nas2dual/database/libri_light_finetuning/tfrecord"
subset_list = [
    "libri_light_10min",
    "libri_light_1h",
    "libri_light_10h",
...
for subset, shards in zip(subset_list, shards_list):
    ...
    process(WAV_TOP_DIR, OUT_TOP_DIR, trans_fn, out_tfrecord_fn, shards)
