...
class NTPDatasetOperation(operation.AbstractOperation):
    """A class for processing data for Next Token Prediction (NTP)."""
    @abc.abstractmethod
    def __init__(self, params: dataset_operation_params.NTPDatasetOperationParams):
        super(Tf2DatasetOperation, self).__init__(params)
