"""A module implementing classes derived from Tf2DatasetOp.
...
class NTPDatasetOp(Tf2DatasetOp):
    """A class for processing data for Next Token Prediction (NTP).
...
#
#
#class DatasetFilterOperation(Tf2DatasetOp):
...
#
#
#class SequenceBatchOperation(Tf2DatasetOp):
#    # TODO(chanw.com) Implement this class with a suitable unit test.
#    pass
#
#
#class DatasetWrapperOperation(Tf2DatasetOp):
...
#
#
#class DatasetTypeConversionOperation(Tf2DatasetOp):
...
#
#
#class DictToTupleDatasetOperation(Tf2DatasetOp):
...
#class UtteranceDataPreprocessor(Tf2DatasetOp):
