...
python wav2vec2_inference.py --checkpoint_dir=/mnt/data/home/chanwcom/models/alpha_0p02_beta_0p1_experiment/checkpoint-2000 --decoder beam_search --beam_size 40 --vocab_size 32  
